...
SECRET_KEY = "django-insecure-*$okz3*23*#=110(0mbuc26-l%irja5*4!v-g)x#*si&q#c90*"
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.environ.get("SQL_PASSWORD", "BZPFqoRgJbVUMTBAPmOMsZUbDohcAJay"),
...
SECRET_KEY = "p8jv-rc^5=e*%fovbogtqn4l@epi))b3ft-^^6hr+2#&t(#@_h"
